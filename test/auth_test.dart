...
void main() {
  group('Mock Authentication', () {
    ...
    test('Cannot log our if not initialized', () {
      expect(
        provider.logout(),
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> login({
    ...
    const user =
        AuthUser(isEmailVerified: false, email: 'foo@bar.com', id: 'my id');
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    const newUser =
        AuthUser(isEmailVerified: true, email: 'foo@bar.com', id: 'my id');
    _user = newUser;
  }
}
